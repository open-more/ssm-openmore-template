...
public class DtoFileUtils {
    ...
    /** 获取模块根目录 */
    public static String getTemplateDirectory() throws Exception{
            String templatePath= FreeMakerConfig.TEMPLATE_ROOT_DIRECTORY;
    ...
    /** 获取模板存放路径 */
    public static List<String> getTemplateFileList() throws Exception{
        try {
            //模板根目录路径
            String projectPath = getTemplateDirectory();
